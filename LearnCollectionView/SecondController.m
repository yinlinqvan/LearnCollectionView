...
@interface SecondController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _data = @[@{@"sectionTitle": @"特别推荐", @"section":@[
                                                        @{@"title": @"1"},
                                                       @{@"title": @"2"},
                                                       @{@"title": @"3"},
                                                       @{@"title": @"1"},
    ...
    _sizeData = @[
                  [NSValue valueWithCGSize:(CGSize){self.view.bounds.size.width, (self.view.bounds.size.width- 20*2)/2.0}],
                  ];
    //1、已注册
    [self.collectionView registerNib:[UINib nibWithNibName:@"SecondCell" bundle:nil] forCellWithReuseIdentifier:reuseIdentifier];
...
{
    NSDictionary *firstSection = _data[0];
    NSArray *section = firstSection[@"section"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SecondCell *cell = (SecondCell *)[collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
